...
export function DashboardWidget({
  ...
  return (
    <Card className="group/widget relative overflow-hidden border-none py-0 shadow-sm ring-1 ring-surface-border transition-all hover:shadow-md hover:ring-brand/40">
      <div className="h-1 bg-gradient-to-r from-brand to-collab" />
      <CardHeader className="flex-row items-center justify-between gap-2 px-5 pt-4 pb-2">
...
/** Icon + short message for a widget with no data — see 06-dashboard-home.md. */
