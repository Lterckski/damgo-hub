...
- **Live collaborative boards** — a shared project roadmap board, a meeting agenda board, and an open ideas board, all editable together in real time (multiple people, same board, live cursors).
- **Meeting scheduling** — proposing and finalizing meeting agendas ahead of time.
